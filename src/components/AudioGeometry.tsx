...
declare module '@react-three/fiber' {
  interface ThreeElements {
    waveMaterial: React.DetailedHTMLProps<React.ObjectHTMLAttributes<WaveMaterial>, WaveMaterial>;
  }
}
...
//         uTime: { value: 0 },
//         uHover: { value: 0 },
//         uColor1: { value: new THREE.Color("#4a5a7e") },
//         uColor2: { value: new THREE.Color("#3f6a90") },
//         uColor3: { value: new THREE.Color("#e94560") },
//         uColor4: { value: new THREE.Color("#5a6a8e") },
//         uAtmosIntensity: { value: 1.2 },
//       },
//       vertexShader: `
//         varying vec2 vUv;
//         varying vec3 vPosition;
...
// declare module "@react-three/fiber" {
//   interface ThreeElements {
//     atmosWaveMaterial: React.DetailedHTMLProps<
//       React.ObjectHTMLAttributes<AtmosWaveMaterial>,
//       AtmosWaveMaterial
//     >;
//   }
// }
...
//   const rings = useMemo(() => {
//     return [
//       { radius: 2.5, tube: 0.008, color: "#e94560", opacity: 0.6 },
//       { radius: 2.8, tube: 0.006, color: "#3f6a90", opacity: 0.5 },
//       { radius: 3.1, tube: 0.01, color: "#e94560", opacity: 0.4 },
//       { radius: 3.4, tube: 0.005, color: "#5a6a8e", opacity: 0.3 },
//     ];
//   }, []);
...
//     // Use a seeded random function to avoid impure Math.random in render
//     let seed = 12345;
//     const seededRandom = () => {
...
//         <pointLight position={[10, 10, 10]} intensity={1.5} color="#e94560" />
//         <pointLight position={[-10, -10, -10]} intensity={0.8} color="#3f6a90" />

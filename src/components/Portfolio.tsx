      ...
      <div className='container mx-auto px-6'>
        <div className='max-w-6xl mx-auto'>
          <div className='text-center mb-16'>
            <p className='text-sm uppercase tracking-[0.2em] text-primary mb-4'>Portfolio</p>
            <h2 className='text-3xl md:text-4xl font-light tracking-tight text-foreground mb-4'>
              Featured <span className='font-medium'>Work</span>
            </h2>
            <p className='text-muted-foreground max-w-xl mx-auto'>
              A selection of recent projects showcasing my mixing and mastering work across various genres.
            </p>
          </div>
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className='aspect-square relative overflow-hidden'>
                  ...
                  />
                  <div className='absolute inset-0 bg-gradient-to-top from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300' />
                ...
                {/* Project Info */}
                <div className='p-6'>
                  <p className='text-xs text-primary font-medium mb-2 uppercase tracking-wider'>{project.type}</p>
                  <h3 className='text-lg font-medium text-foreground mb-1'>{project.title}</h3>
                  <p className='text-sm text-muted-foreground mb-4'>{project.artist}</p>
          ...
          <div className='bg-card rounded-2xl p-8 md:p-12 border border-border'>
            <div className='text-center mb-10'>
              ...
              <h3 className='text-2xl font-medium text-foreground mb-3'>Listen Now</h3>
              ...
              <div className='space-y-4'>
                ...
                <div className='rounded-xl overflow-hidden bg-secondary'>
                  <iframe
                    ...
                    scrolling='no'
                    frameBorder='no'
                    src='https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/1&color=%23e94560&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=false'
            ...
            <div className='text-center mt-10 pt-8 border-t border-border'>
              <p className='text-muted-foreground mb-4'>Want to hear more? Check out my full catalog</p>
